...
// Run once: npx ts-node scripts/seedMatches.ts
...
console.log('Matches to seed:')
console.log(JSON.stringify(matches, null, 2))
console.log('\nCopy this JSON and paste into Firebase Firestore "matches" collection manually,')
console.log('or use the Admin SDK with your service account credentials.')
export { matches }
